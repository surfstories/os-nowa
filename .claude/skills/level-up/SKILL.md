...
**Gate 3 — Pick the lowest autonomy that solves it.**

| Level | What happens |
|---|---|
| 1 | It suggests; the user decides every step |
| 2 | It drafts; the user reviews and sends |
...
- **It does not build more than one thing per run.** Two half-built automations are worth less than
  one that works.
- **It does not push past a gate.** An exit at Gate 1 is the most valuable result this skill
