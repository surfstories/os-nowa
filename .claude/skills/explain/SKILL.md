...
questions arrive in the middle of other work — this skill answers them without derailing that work.
...
**Answer, then return to what they were doing.** This skill interrupts real work; it should hand it
back.
...
2. Nothing was written. This skill is read-only.
