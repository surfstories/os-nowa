...
{{THE_SOLUTION_IN_THREE_SENTENCES_OR_FEWER}}
...
{{THE_PEOPLE_AND_CASES_THIS_DELIBERATELY_DOES_NOT_SERVE. A spec without this section has no edges,
and a project without edges never finishes.}}

## Done looks like

{{THE_OBSERVABLE_CONDITION_THAT_MEANS_IT_IS_FINISHED}}

## Out of scope

{{WHAT_WE_ARE_NOT_BUILDING_AND_WHY}}
