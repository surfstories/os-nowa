...
This is the agent-neutral method. **Claude Code** runs it via the `backtrack` skill; **any other
...
question and guarantees tomorrow's. This procedure does the opposite: it treats the miss as evidence that
...
- **It does not fix the symptom only.** Finding the file the user wanted is the start of this procedure,
  not the end of it.
